...
class AccountControllerTest {
    ...
    @Test
    fun `test find all`() {
        accountRepository.save(Account(name = "Test", document = "123456789", phone = "1234567890"))
    ...
    @Test
    fun `test find by id`() {
        val account = accountRepository.save(Account(name = "Test", document = "123456789", phone = "1234567890"))
    ...
    fun `test create account`() {
        val account = Account(name = "test create", document = "12345678901", phone = "11234567890")
    ...
    fun `test update account`() {
        val account = accountRepository
            .save(Account(name = "Test", document = "123456789", phone = "1234567890"))
            .copy(name = "Updated")
        val json = ObjectMapper().writeValueAsString(account);
    ...
    fun `test create account validation error empty name`() {
        val account = Account(name = "", document = "123456789", phone = "1234567890")
        val json = ObjectMapper().writeValueAsString(account);
        accountRepository.deleteAll()
    ...
    fun `test create account validation error name should be 5 character`() {
        val account = Account(name = "Test", document = "123456789", phone = "1234567890")
        val json = ObjectMapper().writeValueAsString(account);
        accountRepository.deleteAll()
    ...
    fun `test create account validation error empty document`() {
        val account = Account(name = "test create", document = "", phone = "1234567890")
        val json = ObjectMapper().writeValueAsString(account);
        accountRepository.deleteAll()
    ...
    fun `test create account validation error document should be 11 character`() {
        val account = Account(name = "test create", document = "123456789", phone = "1234567890")
        val json = ObjectMapper().writeValueAsString(account);
        accountRepository.deleteAll()
    ...
    fun `test create account validation error empty phone`() {
        val account = Account(name = "test create", document = "12345678912", phone = "")
        val json = ObjectMapper().writeValueAsString(account);
        accountRepository.deleteAll()
    ...
    fun `test create account validation error phone should be 11 character`() {
        val account = Account(name = "test create", document = "12345678912", phone = "123")
        val json = ObjectMapper().writeValueAsString(account);
        accountRepository.deleteAll()
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/accounts")
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("\$.message").isString)
            .andExpect(MockMvcResultMatchers.jsonPath("\$.statusCode").value(400))
            .andExpect(MockMvcResultMatchers.jsonPath("\$.message").value("[phone] deve ter 11 caracteres!"))
            .andDo(MockMvcResultHandlers.print())
    }
}